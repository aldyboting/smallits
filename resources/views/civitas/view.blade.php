<x-viewcivitas-layout>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex flex-row-reverse space-x-4 space-x-reverse ">
        <!--Add button-->
        <button class="mr-12 bg-blue-500 hover:bg-blue-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded" onclick="window.location='{{ route("add-civitas") }}'">Tambah</button>
    </div>
