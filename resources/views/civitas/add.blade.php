                ...
                <div class="w-full min-w-fit py-4 px-8 bg-white shadow-lg rounded-lg mx-auto my-6">
                    <div class="grid grid-cols-2">
                        <div class="justify-items-start">
                            <!--Add button-->
                            <button class="bg-red-500 hover:bg-red-400 text-white font-bold py-2 px-4 border-b-4 border-red-700 hover:border-red-500 rounded" onclick="window.location='{{ route("add-civitas") }}'">Kembali</button>
                        </div>
